...
class ComponentWithBehaviour extends Component {
    ...
    handleClick() {
        ...
        // do not mutate state directly, instead use setState() method.
        // this.state.count += 1;
        ...
        // put the code in the callback function of setState().
        this.setState({ count: this.state.count + 1 }, () => {
            console.log("Inside setState() callback, this.state.count:", this.state.count);
        });
    }
